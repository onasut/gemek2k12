...
switch (curPageURL()) {
	case "http://192.168.0.196/gemek2k12/account_plan.php": 
	case "http://127.0.0.1/gemek2k12/account_plan.php":
	case "http://localhost/gemek2k12/account_plan.php":	
		goto footer;
}
